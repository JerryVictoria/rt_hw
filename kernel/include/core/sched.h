...
/* MLFQ related macro */
#define MLFQ_QUEUE_LEVEL 	3
#define MLFQ_QUEUE_SIZE  	512
#define MLFQ_BOOST_GAP		3
...
uint32_t pok_sched_part_prio (const uint32_t ,const uint32_t,const uint32_t prev_thread,const uint32_t current_thread);
